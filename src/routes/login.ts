import { RouteBases, Routes, type RESTGetCurrentUserGuildMemberResult, type RESTPostOAuth2AccessTokenResult, type RESTPostOAuth2AccessTokenURLEncodedData } from 'discord-api-types/v10'
